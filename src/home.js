    ...
    return (
        <div>
            <div className={style.container}>
                ...
                <img className={style.flipkart}src={flip} alt='flipkart'/>
                <input type='text' placeholder="Search for products,brands and more" autoComplete="off"/>
                ...
                {/* <svg width="4.7" height="8" viewBox="0 0 16 27" xmlns="http://www.w3.org/2000/svg" class="_34Yjv1"><path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z" fill="#fff" class="_14jSvk">
                    </path></svg> */}
